...
const char* WIFI_PASSWORD = "nost890@";
...
// ================== HTML PAGE (FINAL VERSION WITH DUAL BOXES) ==================
  ...
  <div class="main-content">
    ...
    <div class="dashboard-grid">
      ...
      <div class="card storage-panel">
        ...
        <div class="stat-value" id="storageValue">2.0 MB</div>
...
s->set_vflip(s, 1);    // Flip vertically → UPSIDE DOWN
s->set_hmirror(s, 0);  // Do not flip horizontally
}
